...
if __name__ == '__main__':
    ...
    dct_of_pkl = {
            ...
            "D": r"stat_test\processed_data\Test2_2.pkl",
            "B": r"stat_test\processed_data\Test1_2.pkl"
        }
    ...
    if save_fig:
        fig_sig.savefig(os.path.join(BASE_OUTPUT_DIR, 'std_err_plot_all_tests.png'), dpi=400)
